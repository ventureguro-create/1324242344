...
const TelegramLeaderboardPage = lazy(() => import("./pages/TelegramLeaderboardPage"));
// Block UI-2: Channel Detail Page
const TelegramChannelPage = lazy(() => import("./pages/TelegramChannelPage"));
// Block UI-6: Movers Page
const TelegramMoversPage = lazy(() => import("./pages/TelegramMoversPage"));
// Block ALERTS: Alerts Page
const TelegramAlertsPage = lazy(() => import("./pages/TelegramAlertsPage"));
// Block 5.1: Watchlist Page
