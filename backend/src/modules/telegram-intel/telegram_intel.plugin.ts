...
export const telegramIntelPlugin: FastifyPluginAsync = async (fastify) => {
  ...
  await fastify.register((await import('./routes/channel_full.routes.js')).channelFullRoutes);

  // ==================== Block UI-6: Movers ====================
  
  await fastify.register((await import('./routes/movers.routes.js')).moversRoutes);

  // ==================== Block GOV-1: Governance Admin ====================
  
  await fastify.register((await import('./routes/governance_admin.routes.js')).governanceAdminRoutes);

  // ==================== Block ALERTS: Alerts Engine ====================
  
  await fastify.register((await import('./routes/alerts.routes.js')).alertsRoutes);

  // ==================== Momentum Engine (M-1, M-2) ====================
  ...
  await fastify.register((await import('./lifecycle/lifecycle.routes.js')).lifecycleRoutes);
  ...
  await fastify.register((await import('./alerts/user_alerts.routes.js')).userAlertsRoutes);
