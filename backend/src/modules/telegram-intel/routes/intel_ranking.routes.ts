 ...
 * Phase 3 Step 5 + Block UI-1: Production Leaderboard
 */
...
export const intelRankingRoutes: FastifyPluginAsync = async (fastify) => {
  ...
  // NOTE: /api/telegram-intel/intel/list is now handled by leaderboard.routes.ts (PATCH-1, PATCH-3)
  // with mode=intel|momentum support and materialized views
